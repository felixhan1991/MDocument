            ...
            <div class="col-sm-12">
                <section class="panel">
                    ...
                    <div class="adv-table">
                        ...
                        <div class="btn-group">
                            <button class="btn btn-primary" onclick="window.location='<?php echo base_url().'documents/manage/form' ?>'">
                        ...
                        <td >        
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu " role="menu">
                                    ...
                                    <li ><a href="#" onclick="window.location='<?php echo base_url().'documents/manage/done/'.$doc->id_dokumen?>'" ><i class="fa fa-check"></i> Siap dipublikasikan!</a></li>
                                    <?php } ?>
                                    <li class="divider"></li>
                                    <?php if ($doc->id_status!=6 && $doc->id_status!=5) { ?>
                                    <li><a href="#" onclick="window.location='<?php echo base_url().'documents/manage/edit/'.$doc->id_dokumen?>'"><i class="fa fa-refresh"></i> Update</a></li>
                                    <?php } ?>
