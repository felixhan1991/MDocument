<form class="cmxform form-horizontal " enctype="multipart/form-data"  id="commentForm" method="post" action="<?php echo base_url().'documents/manage/edit/'.$document->id_dokumen?>">
<div class="row">
        <div class="col-lg-12">
