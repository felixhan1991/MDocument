...
<div class="row">
        <div class="col-lg-12">
            <div class="text-right" id="nestable_list_menu">
                <button class="btn btn-default" type="button" onclick="window.location='<?php echo base_url().'documents/form/edit/'.$document->id_dokumen?>'">Kembali</button>
            </div>
        </div>
</div>
<div class="row">
                                ...
                                <tr class="unread">
                                    ...
                                    <td>
                                           <button type="button" class="btn btn-danger btn-xs " 
                                            onclick="window.location='<?php echo base_url().'file/removeFileReferensi?id_doc='.$file->id_dokumen.
