<form class="cmxform form-horizontal " enctype="multipart/form-data"  id="commentForm" method="post" action="<?php echo base_url().'documents/form/edit/'.$document->id_dokumen?>">
<div class="row">
        <div class="col-lg-12">
                    ...
                    <div class="form">
                        <input type="hidden" name="id_dokumen" value="<?php echo $document->id_dokumen?>"/>
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-lg-8">
                                    <input class=" form-control" id="judul" name="judul" type="text" required value="<?php echo $document->nama_dokumen?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <select id="e1" class="populate " name="status" required style="min-width: 300px">
            ...
            <section class="panel">
                                    ...
                                    <select multiple name="drafter[]" id="author" style="min-width:300px" class="populate">
                                        <?php foreach ($users as $s) {
                                            if (in_array($s->id_akun, $drafters))
                                                echo '<option value="'.$s->id_akun.'" selected>'. $s->nama.'</option>';
                                            else
                                                echo '<option value="'.$s->id_akun.'">'. $s->nama.'</option>';   
                                        } ?>
                                    </select>
                                </div>
                            </div>
                ...
                <section class="panel">
                    <header class="panel-heading wht-bg">
                       Daftar Versi Dokumen (<a href="<?php echo base_url().'documents/form/editFiles/'.$document->id_dokumen?>">more details</a>)
                       <span class="tools pull-right">
                        <a class="fa fa-chevron-down" href="javascript:;"></a>
                     </span>
                    </header>
