        ...
        <div class="col-lg-12">
            ...
            <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form">
                            <div class="form-group">
                                <label class="col-lg-3  control-label">Admin Penanggung Jawab</label>
                                <div class="col-lg-8">
                                    
                                    <select id="e9" class="populate " name="admin" style="min-width: 300px" required>
                                        <?php foreach ($users_del as $s) {
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <select multiple name="reviewer[]" id="review" style="min-width:300px" class="populate" required>
                                        <?php foreach ($users as $s) {?>
                                            <option value="<?php echo $s->id_akun?>"><?php echo $s->nama?></option>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <select multiple name="approval[]" id="editor" style="min-width:300px" class="populate" required>
                                       <?php foreach ($users as $s) {?>
                                            <option value="<?php echo $s->id_akun?>"><?php echo $s->nama?></option>
                                        <?php } ?>
                                    </select>
