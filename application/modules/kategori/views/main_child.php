            ...
            <div class="col-sm-12">
                ...
                <section class="panel">
                    <header class="panel-heading">
                        Kategori Dokumen: <b><?php echo AkunFactory::Instance()->getNameKategori($current_id);?></b>
                    ...
                    <div class="panel-body">
                        <div class="adv-table editable-table ">
                            <div class="btn-group">
                            <button class="btn btn-primary" onclick="window.location='<?php echo base_url().'kategori/viewChild/'.$parent_id ?>'">
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal bucket-form" method="post" action="<?php echo base_url().'kategori/viewChild/'.$current_id;?>">
